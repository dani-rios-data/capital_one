      ...
      <div style={styles.container}>
        ...
        <section style={styles.methodologySection}>
          ...
          <p style={styles.paragraph}>
            Our team conducted an extensive analysis of Capital One's advertising strategy by scraping and analyzing over 250,000 ad placements containing more than 1,200 unique advertisements from 2024, sourced through Pathmatics, Inc. Using advanced AI and natural language processing, we extracted and analyzed text transcripts, visual elements, product placements, and messaging themes across multiple platforms. This comprehensive dataset allowed us to identify distinct audience segments based on the specific language, imagery, benefits, and product features emphasized across Capital One's marketing communications. By categorizing these targeting patterns, we've developed a framework that reveals how Capital One strategically positions its various financial products to different customer groups.
          </p>
        </section>
